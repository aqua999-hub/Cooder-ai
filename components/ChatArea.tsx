...
export const ChatArea: React.FC<ChatAreaProps> = ({ messages, onSendMessage, isLoading }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0d1117]">
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center p-8 text-center">
            ...
            <p className="text-[#8b949e] max-w-lg text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-3 mt-8 max-w-md w-full">
              {['Debug my code', 'Refactor function', 'Write unit tests', 'Explain architecture'].map(opt => (
                <button 
                  ...
                  className="p-3 text-xs border border-[#30363d] rounded-lg hover:bg-[#161b22] text-[#8b949e] transition-colors text-left"
                >
                  {opt} →
                </button>
              ))}
          ...
          <div className="divide-y divide-[#30363d]/30">
              ...
              >
                <div className="max-w-4xl mx-auto flex gap-5 md:gap-8">
                  <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 shadow-lg ${
                    m.role === 'assistant' ? 'bg-indigo-600 text-white' : 'bg-[#30363d] text-[#8b949e]'
                  }`}>
            ...
            {isLoading && (
              <div className="py-8 px-4 md:px-12 bg-[#161b22]/20">
                <div className="max-w-4xl mx-auto flex gap-5 md:gap-8">
      ...
      <div className="p-6 md:p-8 bg-gradient-to-t from-[#0d1117] via-[#0d1117] to-transparent">
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto relative group">
          <textarea
            ...
            className="w-full bg-[#161b22] border border-[#30363d] rounded-xl pl-5 pr-14 py-4 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 transition-all resize-none min-h-[64px] max-h-60 text-[#f0f6fc] shadow-2xl placeholder:text-[#484f58]"
            rows={1}
        ...
        <p className="text-[10px] text-[#484f58] text-center mt-4 tracking-wider font-medium uppercase opacity-50">
